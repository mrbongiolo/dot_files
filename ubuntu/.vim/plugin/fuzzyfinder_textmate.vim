...
" since they can't be called from outside fuzzyfindervimfiles
" ====================================================================================
...
RUBY
  ...
  " ================================================================================
  " This function is copied almost whole-sale from fuzzyfindervimfiles. Ideally, I could
  " used the on_complete callback to more cleanly add the new behavior, but the
  " TextMate-style completion broke a few of fuzzyfindervimfiles's assumptions, and the
