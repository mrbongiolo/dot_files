...
if s:inRailsEnv()
    ...
    call NERDSnippetsFromDirectoryForFiletype('~/vimfiles/snippets/ruby-factorygirl', 'ruby')
else
...
function! Snippet_Modeline()
    return s:start_comment() . "vimfiles: set <+settings+>:" . s:end_comment()
endfunction
